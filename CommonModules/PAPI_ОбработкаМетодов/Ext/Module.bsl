...
Функция ТелоИнфо() Экспорт
	...
	Возврат "
			...
			|</br>
			|Тело запроса: Данные в формате json</br>
			|</br>
			|АдресСервера: IP-адрес или имя компьютера</br>
			|ИмяПубликации: Имя на закладке Основные (Администрирование - Публикация на веб-сервере)</br>
			|<ul>
